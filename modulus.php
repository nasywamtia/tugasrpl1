...
.hitung{background:#14b8a6;width:100%;margin-top:8px}
.hapus{background:#ef4444}
.hasil{margin-top:10px;padding:10px;background:#ecfeff;border-radius:6px}
...
<div class="hasil"><?= implode(" % ",$input) ?> = <b><?= $hasil ?></b> (<?= $teks ?>)</div>
<?php endif; ?>
